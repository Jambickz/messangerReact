...
`,Pj=S.memo(({dialog:t,usersDialog:e,currentUser:n,group:r})=>{const[i,s]=S.useState(!1),o=e.find(a=>a.uid!==n.uid);return S.useEffect(()=>{if(s(!1),!o)return;const a=ac(dc,"users/"+o.uid+"/connections"),l=u=>{const c=u.val();s(h=>!!c||h)};return kT(a,l),()=>{GM(a,l)}},[e]),!r&&!o?w("div",{children:"Choice dialog"}):X(Dj,{children:[X(Oj,{children:[w(Lj,{children:w("img",{src:r?t.avatar:o&&o.photoURL,alt:"photo"})}),X(Mj,{children:[w($j,{children:r?t.name:o&&o.displayName}),r?null:w(Fj,{status:i,children:w("div",{className:"online",children:i?"online":"offline"})})]}),w(zj,{children:r?void 0:o&&o.username})]}),X(jj,{children:[w(Uj,{children:"Call"}),w(Vj,{children:"Archive"}),w(Bj,{children:"View profile"})]})]})}),Dj=x.div`
  flex-basis: 100px;
