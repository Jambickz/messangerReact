...
`,dz=({currentUser:t})=>w(oz,{children:X(az,{children:[w(lz,{children:"GayProject"}),w(uz,{children:X(cz,{children:[w(ys,{children:w(tr,{to:"/",children:"Home"})}),w(ys,{children:w(tr,{to:"/dashboard",children:"Dashboard"})}),w(ys,{children:w(tr,{to:"/projects",children:"Projects"})}),w(ys,{children:w(tr,{to:"/tasks",children:"Tasks"})}),w(ys,{children:w(tr,{to:"/bugtracker",children:"Bugtracker"})}),w(ys,{children:w(tr,{className:t?"online":null,to:"/messenger",children:"Messenger"})})]})}),X(hz,{children:[w(Zo,{children:w(fR,{size:25})}),w(Zo,{children:w(sz,{size:25})}),w(Zo,{children:w(nz,{size:25})}),t&&w(Zo,{children:w("img",{src:t.photoURL,alt:""})}),t&&w(Zo,{onClick:()=>hD(Md),children:w(iz,{size:40})}),!t&&w(tr,{to:"/login",children:w(rz,{size:40})})]})]})}),fz=R.div`
  display: flex;
...
`,Iz=()=>{const t=Vd();return X(Sz,{onSubmit:async n=>{n.preventDefault();const r=n.target[0].value,i=n.target[1].value;await wz(r,i),t("/")},children:[w(G1,{type:"email",placeholder:"email"}),w(G1,{type:"password",placeholder:"password"}),w(Cz,{children:"Sign in"})]})},Tz=R.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  margin-top: 50px;
...
`,Rz=()=>X(Tz,{children:[w(kz,{children:"Login"}),w(Iz,{}),w(xz,{to:"/register",children:"or Register"})]}),Nz=R.form`
  display: flex;
  flex-direction: column;
  align-items: center;
  gap: 1rem;
...
`,Pz=()=>{const t=Vd();return X(Nz,{onSubmit:async n=>{n.preventDefault();const r=n.target[0].value,i=n.target[1].value,s=n.target[2].value,o=n.target[3].files[0],a=await gz(i,s),l=await yz(i,o,r),u=await Ez();await vz(a.user,{displayName:r,photoURL:l}),await _z(a.user.uid,{displayName:r,email:i,photoURL:l,uid:a.user.uid,userId:u+1,displayNameLower:r.toLowerCase()}),t("/")},children:[w(ip,{type:"text",placeholder:"Display name"}),w(ip,{type:"email",placeholder:"Email"}),w(ip,{type:"password",placeholder:"Password"}),w(Az,{htmlFor:"file",children:w("span",{children:"Choose a photo"})}),w("input",{style:{display:"none"},type:"file",id:"file"}),w(bz,{type:"submit",children:"Sign up"})]})},Dz=R.div`
  display: flex;
  flex-direction: column;
  align-items: center;
  margin-top: 50px;
...
`,Mz=()=>X(Dz,{children:[w(Oz,{children:"Register"}),w(Pz,{}),w(Lz,{to:"/login",children:"or Login"})]}),$z=()=>w("div",{children:"DashboardPage"}),Fz=()=>w("div",{children:"ProjectsPage"}),Uz=()=>w("div",{children:"TasksPage"}),Vz=()=>w("div",{children:"ReportingPage"}),Sh=t=>{const e=new Date(t),n=e.getHours().toString().padStart(2,"0"),r=e.getMinutes().toString().padStart(2,"0");return`${n}:${r}`},Bz=R.div`
  border-bottom: none;
  a {
    &.active {
      display: block;
...
`;R.div``;const Qz=({dialog:t,user:e})=>{const[n,r]=I.useState(null),i=t.group;return I.useEffect(()=>{const s=t.users.find(a=>a!==e.uid),o=Yv(di(gt,"users",s),a=>{const l=a.data();r(l)});return()=>o()},[t]),w(Bz,{children:w(tr,{to:"/messenger/"+(i?t.groupId:n&&n.username||n&&n.userId),children:X(zz,{children:[X(Wz,{children:[w(Kz,{children:w("img",{src:i?t.avatar:n&&n.photoURL,alt:"photo"})}),X(Gz,{children:[w(Hz,{children:i?t.name:n&&n.displayName}),w("div",{children:t.lastAt?Sh(t.lastAt.toDate()):Sh(new Date)})]}),w(qz,{children:i?void 0:n&&n.username})]}),w(jz,{children:t.lastMessage})]})})})},Yz=R.div`
  height: 60vh;
  max-height: 100vh;
  overflow: auto;
`,Xz=({currentUser:t})=>{const[e,n]=I.useState([]);return I.useEffect(()=>{const r=kM(_n(gt,"dialogs"),Di("users","array-contains",t.uid),Hv("lastAt","desc"),R3(50)),i=Yv(r,s=>{const o=[];s.forEach(a=>{const l=a.data();o.push(l)}),n(o)});return()=>i()},[t]),w(Yz,{children:e.map(r=>w(Qz,{user:t,dialog:r},r.id))})},Jz=R.div`
...
`,H5=R.span`
  ...
  color: ${({isFromSender:t})=>t?"var(--colors-ui-style)":"var(--colors-text)"};
  font-size: 12px;
`,q5=({isFromSender:t,message:e})=>w(j5,{isFromSender:t,children:X(W5,{isFromSender:t,children:[e.text,w(H5,{isFromSender:t,children:e.createdAt?Sh(e.createdAt.toDate()):Sh(new Date)})]})}),sp=async t=>(await ru(t)).docs.map(e=>e.data()),G5=async(t,e,n)=>{if(!t)return;const r=_n(gt,"dialogs"),i=async()=>{let a=null;+t?a=Pi(_n(gt,"users"),Di("userId","==",+t)):a=Pi(_n(gt,"users"),Di("username","==",t));const l=await sp(a);return n([l[0]]),await s(l[0].uid)},s=async a=>{const l=Pi(r,Di("users","in",[[e.uid,a],[a,e.uid]]));return(await sp(l))[0]},o=async()=>{const a=Pi(r,Di("groupId","==",+t)),l=await sp(a);return K5(e,l[0],n),l[0]};return+t<0?o():i()},K5=async(t,e,n)=>{const r=e.users.filter(s=>s!==t.uid),i=[t];for(const s of r){const o=di(gt,"users",s),a=await O3(o);if(a.exists()){const l=a.data();i.push(l)}}n(i)},Q5=async(t,e)=>{const n=yl(),r=di(_n(gt,"dialogs"));return await Od(r,{users:[t,e],lastAt:n,id:r.id}),console.log(`Dialog ${r.id}`),r.id},Y5=async({fromId:t,text:e},n)=>{const r=yl(),i=di(_n(gt,"messages"));await Od(i,{id:i.id,fromId:t,dialogId:n,text:e,attachment:[!1],createdAt:r}),console.log(`Message ${i.id}`),Qm(di(gt,"dialogs",n),{lastMessage:e,lastAt:r})},X5=R.form`
  display: flex;
  align-items: center;
  margin-top: 10px;
  padding: 10px;
...
`,J5=({currentUser:t,dialog:e,setUpdateDialog:n,usersDialog:r,updateDialog:i})=>{const s=r.find(u=>u.uid!==t.uid),[o,a]=I.useState("");return X(X5,{onSubmit:async u=>{u.preventDefault();const c=u.target[0].value,h=t.uid;let d="";e?d=e.id:(d=await Q5(h,s.uid),n([d])),Y5({fromId:h,text:c},d),a("")},children:[w("input",{type:"text",placeholder:"Send Message",value:o,onChange:u=>a(u.target.value)}),w("button",{children:"Send"})]})},Z5=R.div`
  padding: 5px 50px;
`,ej=R.div`
  position: relative;
  display: grid;
...
`,Ej=R.div`
  display: flex;
  flex-direction: column;
`,Sj=R.div``,Cj=()=>{const{currentUser:t}=I.useContext(ds),{id:e}=OV(),[n,r]=I.useState(null),[i,s]=I.useState([]),[o,a]=I.useState(!1),[l,u]=I.useState([]);console.log(e);const[c,h]=I.useState(null);return I.useEffect(()=>{(async()=>{h(e),a(!1);const p=await G5(e,t,s);r(p),p&&a(p.group)})()},[e,l]),X(Sj,{children:[w(wj,{children:c&&w(_j,{group:o,usersDialog:i,dialog:n,currentUser:t})}),X(Ej,{children:[c&&w(aj,{dialog:n,currentUser:t,usersDialog:i}),!c&&w("div",{children:"Choice dialog"}),c&&w(J5,{currentUser:t,setUpdateDialog:u,dialog:n,usersDialog:i,updateDialog:l})]})]})},Ij=R.div`
  width: 100%;
...
`,Rj=R.article`
  ...
  width: 100%;
`,Q1=()=>X(kj,{children:[w(xj,{children:"All messages"}),X(Rj,{children:[w(z5,{}),w(Tj,{})]})]}),Nj=({isAuth:t})=>t?w(Jx,{to:"/"}):w(i_,{}),Aj=async t=>{if(!t)return;const e=t.uid,n=di(gt,"users",e),r=CM(G4,".info/connected");window.addEventListener("beforeunload",async i=>{i.preventDefault(),await Qm(n,{online:!1,lastOnline:yl()})}),TM(r,i=>{i.val()===!0&&Qm(n,{online:!0,lastOnline:yl()})})},bj=({isAuth:t})=>t?w(i_,{}):w(Jx,{to:"/login"}),Pj=[{path:"dashboard",component:$z},{path:"projects",component:Fz},{path:"tasks",component:Uz},{path:"bugtracker",component:Vz},{path:"messenger",component:Q1},{path:"messenger/:id",component:Q1}],Dj=()=>{const{currentUser:t}=I.useContext(ds);return Aj(t),w(YV,{children:w(HV,{children:X(Zn,{path:"/",element:w(mz,{}),children:[w(Zn,{index:!0,element:w(eB,{})}),X(Zn,{element:w(Nj,{isAuth:t}),children:[w(Zn,{path:"register",element:w(Mz,{})}),w(Zn,{path:"login",element:w(Rz,{})})]}),w(Zn,{element:w(bj,{isAuth:t}),children:Pj.map(e=>{const n=e.component,r=e.path;return w(Zn,{path:r,element:w(n,{})},r)})}),w(Zn,{path:"*",element:w("div",{children:"Not Found"})})]})})})},Oj=()=>{const[t,e]=I.useState(!0);return X(K4,{setIsLoading:e,children:[t&&w(Q4,{}),!t&&w(Dj,{})]})};ap.createRoot(document.getElementById("root")).render(w(rn.StrictMode,{children:w(Oj,{})}));
