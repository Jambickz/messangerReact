...
`,dz=({currentUser:t})=>w(oz,{children:X(az,{children:[w(lz,{children:"GayProject"}),w(uz,{children:X(cz,{children:[w(gs,{children:w(tr,{to:"/",children:"Home"})}),w(gs,{children:w(tr,{to:"/dashboard",children:"Dashboard"})}),w(gs,{children:w(tr,{to:"/projects",children:"Projects"})}),w(gs,{children:w(tr,{to:"/tasks",children:"Tasks"})}),w(gs,{children:w(tr,{to:"/bugtracker",children:"Bugtracker"})}),w(gs,{children:w(tr,{className:t?"online":null,to:"/messenger",children:"Messenger"})})]})}),X(hz,{children:[w(Zo,{children:w(fR,{size:25})}),w(Zo,{children:w(sz,{size:25})}),w(Zo,{children:w(nz,{size:25})}),t&&w(Zo,{children:w("img",{src:t.photoURL,alt:""})}),t&&w(Zo,{onClick:()=>hD(Md),children:w(iz,{size:40})}),!t&&w(tr,{to:"/login",children:w(rz,{size:40})})]})]})}),fz=R.div`
  display: flex;
...
`,Rj=R.article`
  ...
  width: 100%;
`,Q1=()=>X(kj,{children:[w(xj,{children:"All messages"}),X(Rj,{children:[w(z5,{}),w(Tj,{})]})]}),Nj=({isAuth:t})=>t?w(Jx,{to:"/"}):w(i_,{}),Aj=async t=>{if(!t)return;const e=t.uid,n=di(gt,"users",e),r=CM(G4,".info/connected");window.addEventListener("beforeunload",async i=>{i.preventDefault(),await Km(n,{online:!1,lastOnline:yl()})}),TM(r,i=>{i.val()===!0&&Km(n,{online:!0,lastOnline:yl()})})},bj=({isAuth:t})=>t?w(i_,{}):w(Jx,{to:"/login"}),Pj=[{path:"dashboard",component:$z},{path:"projects",component:Fz},{path:"tasks",component:Uz},{path:"bugtracker",component:Vz},{path:"messenger",component:Q1},{path:"messenger/:id",component:Q1}],Dj=()=>{const{currentUser:t}=I.useContext(ds);return Aj(t),w(YV,{children:w(HV,{children:X(Zn,{path:"/messangerReact/",element:w(mz,{}),children:[w(Zn,{index:!0,element:w(eB,{})}),X(Zn,{element:w(Nj,{isAuth:t}),children:[w(Zn,{path:"register",element:w(Mz,{})}),w(Zn,{path:"login",element:w(Rz,{})})]}),w(Zn,{element:w(bj,{isAuth:t}),children:Pj.map(e=>{const n=e.component,r=e.path;return w(Zn,{path:r,element:w(n,{})},r)})}),w(Zn,{path:"*",element:w("div",{children:"Not Found"})})]})})})},Oj=()=>{const[t,e]=I.useState(!0);return X(K4,{setIsLoading:e,children:[t&&w(Q4,{}),!t&&w(Dj,{})]})};op.createRoot(document.getElementById("root")).render(w(rn.StrictMode,{children:w(Oj,{})}));
