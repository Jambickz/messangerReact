...
`,Rj=R.article`
  ...
  width: 100%;
`,Q1=()=>X(kj,{children:[w(xj,{children:"All messages"}),X(Rj,{children:[w(z5,{}),w(Tj,{})]})]}),Nj=({isAuth:t})=>t?w(Jx,{to:"/"}):w(i_,{}),Aj=async t=>{if(!t)return;const e=t.uid,n=di(gt,"users",e),r=CM(G4,".info/connected");window.addEventListener("beforeunload",async i=>{i.preventDefault(),await Km(n,{online:!1,lastOnline:yl()})}),TM(r,i=>{i.val()===!0&&Km(n,{online:!0,lastOnline:yl()})})},bj=({isAuth:t})=>t?w(i_,{}):w(Jx,{to:"/login"}),Pj=[{path:"dashboard",component:$z},{path:"projects",component:Fz},{path:"tasks",component:Uz},{path:"bugtracker",component:Vz},{path:"messenger",component:Q1},{path:"messenger/:id",component:Q1}],Dj=()=>{const{currentUser:t}=I.useContext(ds);return Aj(t),w(YV,{children:w(HV,{children:X(Zn,{path:"/",element:w(mz,{}),children:[w(Zn,{index:!0,element:w(eB,{})}),X(Zn,{element:w(Nj,{isAuth:t}),children:[w(Zn,{path:"register",element:w(Mz,{})}),w(Zn,{path:"login",element:w(Rz,{})})]}),w(Zn,{element:w(bj,{isAuth:t}),children:Pj.map(e=>{const n=e.component,r=e.path;return w(Zn,{path:r,element:w(n,{})},r)})}),w(Zn,{path:"*",element:w("div",{children:"Not Found"})})]})})})},Oj=()=>{const[t,e]=I.useState(!0);return X(K4,{setIsLoading:e,children:[t&&w(Q4,{}),!t&&w(Dj,{})]})};op.createRoot(document.getElementById("root")).render(w(rn.StrictMode,{children:w(Oj,{})}));
