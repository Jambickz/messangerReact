...
`,N5=({user:t})=>w(tr,{to:"/messangerReact/messenger/"+(t.username||t.userId),children:w(C5,{children:X(I5,{children:[w(R5,{children:w("img",{src:t.photoURL,alt:"photo"})}),w(x5,{children:w(T5,{children:t.displayName})}),t.username&&w(k5,{children:t.username})]})})}),A5=R.div`
  margin: 12px 20px;
`,b5=R.div`
  display: flex;
  flex-direction: row;
